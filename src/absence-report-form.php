...
<main>
    ...
    <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate="">
            <div class="row g-3">
                <div class="col-md-4">
                    <label for="state" class="form-label">Nome docente</label>
                    <select class="form-select" id="state" required="" disabled>
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="date" placeholder="gg/mm/aaaa" required="">
                </div>
